...
def test_filter_ignore_block_with_beginning_and_end_on_same_line_correct_order(): # pylint: disable C0301
    """Test that the ignore block is properly removed if it has relevant
    information on the same line.
    """
    text = cleandoc(
...
def test_filter_ignore_block_with_beginning_and_end_on_same_line_wrong_order():
    ...
    information on the same line.
    """
    text = "Relevant textREUSE_IGNORE_ENDOther relevant textREUSE_IGNORE_BEGINIgnored text" # pylint: disable C0301
