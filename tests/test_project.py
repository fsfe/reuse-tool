...
def test_reuse_info_of_uncommentable_file(empty_directory):
    ...
    assert len(result) == 1
    assert result[0].copyright_notices
...
def test_reuse_info_of_only_copyright(fake_repository):
    ...
    assert (
        reuse_info.copyright_notices.pop()
        == "SPDX-FileCopyrightText: 2017 Jane Doe"
    )
...
def test_reuse_info_of_toml_precedence(empty_directory):
    ...
    assert "2017 Jane Doe" in reuse_info.copyright_notices
...
def test_reuse_info_of_closest_precedence(empty_directory):
    ...
    assert "SPDX-FileCopyrightText: In File" in reuse_info.copyright_notices
...
def test_reuse_info_of_aggregate_and_closest(empty_directory):
    ...
    assert project.reuse_info_of("src/foo.py") == [
        ...
        ReuseInfo(
            ...
            copyright_notices={"2017 John Doe"},
            path="src/foo.py",
    ...
    assert project.reuse_info_of("src/foo.py") == [
        ...
        ReuseInfo(
            ...
            copyright_notices={"Copyright Example"},
            path="src/foo.py",
...
def test_reuse_info_of_copyright_xor_licensing(empty_directory):
    ...
    foo_toml_info = [info for info in foo_infos if info.copyright_notices][0]
    ...
    assert not foo_file_info.copyright_notices
    ...
    assert not bar_toml_info.copyright_notices
    bar_file_info = [info for info in bar_infos if info.copyright_notices][0]
...
def test_reuse_info_of_reuse_toml_dot_license(empty_directory):
    ...
    assert "2017 Jane Doe" in toml_info.copyright_notices
    ...
    assert (
        "SPDX-FileCopyrightText: 2017 John Doe"
        in dot_license_info.copyright_notices
    )
