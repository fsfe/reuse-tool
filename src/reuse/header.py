...
def _get_separator(style: Type[CommentStyle], text: str) -> str:
    ...
    if style == PythonCommentStyle:
        # If the style is Python and a docstring follows, persist the spacing
        # around the license. It is preferred by some Python formatting tools
        # for there to be no space between the license and docstring, so allow
        # users the flexibility in formatting as they wish.
